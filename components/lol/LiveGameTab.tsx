    ...
    <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 mb-8">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          {/* Display all players - single column for Arena, two columns for other modes */}
          {isArenaGame ? (
            <div>
              <h3 className="text-sm font-bold mb-3 text-orange-400">All Players</h3>
              <div className="space-y-2">
                {liveGameData.participants.map((participant: any, idx: number) => {
